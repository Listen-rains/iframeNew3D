...
window.addEventListener('load', e => {
    ...
    createApp({
        ...
        sceneURL: params.load || '__URL__my_awesome_app.gltf'.replace('__URL__', ''),
...
function prepareExternalInterface(app) {
    ...
    app.ExternalInterface.externalFunction = function (x,y) {
...
function runCode(app, puzzles) {
    ...
    // puzzles.procedures['interiorFunction'] ('show')

    function setModel (x) {

        return puzzles.procedures['interiorFunction'] (x)
    }
